    ...
    return (
        <div className="cart-dropdown absolute right-0 top-0 h-[746px] mt-3 bg-white border border-gray-200 shadow-lg rounded-md w-[417px] p-4 z-10">
            <div className='flex items-center justify-between border-b pb-[26px]'>
                ...
                <svg onClick={onClose} className='cursor-pointer' width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='flex flex-col justify-between min-h-[652px]'>
                <div className='pt-[42px]'>
                    <div className="mb-5 flex items-center justify-between"> <img src={Gallery4} alt="" />
                        <div>
                            <p>Asgaard sofa</p>
                            <span className=''>1</span>
                            <a href="" className='text-[12px] mx-[15px]'>X</a>
                            <span className='text-page-active text-[12px]'>Rs. 250,000.00</span>
                        </div>
                    ...
                    <div className="flex items-center justify-between"> <img src={Gallery3} alt="" />
                        <div>
                            <p>Casaliving Wood</p>
                            <span className=''>1</span>
                            <a href="" className='text-[12px] mx-[15px]'>X</a>
                ...
                <div>
                    <div className='flex justify-around border-b pb-[24px] mb-[26px] border-[#D9D9D9]'>
                        <p>Subtotal</p>
                        <p className='text-page-active'>Rs. 520,000.00</p>
                    </div>
                    <div className='flex gap-[14px]'>
                    <button className="checkout-button bg-transparent border border-black text-[12px] text-black py-2 px-4 mt-3 w-full rounded-3xl">
                        Cart
                    </button>
                    <button className="checkout-button bg-transparent border border-black text-[12px] text-black py-2 px-4 mt-3 w-full rounded-3xl">
                        Checkout
